...
def run_activation_extraction(model_key, dataset, activations_dir=None):
    ...
    # if combined file exists, use it
...
def main():
    ...
    # 2) build per-task probe output dirs under args.output_dir
