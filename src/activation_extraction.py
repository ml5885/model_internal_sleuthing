...
def extract_and_save(data_path, output_path, model_key):
    # Load the dataset (CSV should include at least "Sentence" and "Target Index" columns)
...
def parse_args():
    ...
    parser.add_argument("--output", type=str, required=True, help="Output NPZ file path for activations.")
    parser.add_argument("--model", type=str, default="gpt2", help="Model key as defined in config.py")
